...
export default function Home() {
  const [selectedCase, setSelectedCase] = useState<AICaseData | null>(null)
  const [showInstructions, setShowInstructions] = useState(true)

  const handleMarkerClick = useCallback((caseData: AICaseData) => {
  ...
  return (
    <main className="relative w-full h-screen overflow-hidden bg-[#020a18]">
      ...
      <div className="absolute inset-0">
        <GlobeView onMarkerClick={handleMarkerClick} />
      </div>
      ...
      {/* Detail panel */}
      <DetailPanel caseData={selectedCase} onClose={handleClosePanel} />
